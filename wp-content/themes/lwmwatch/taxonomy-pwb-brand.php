...
get_header( 'shop' );
   ...
   $queried_object = get_queried_object();
    ...
    if( is_tax('pwb-brand') ){
      ...
      $brand_logo = get_term_meta( $queried_object->term_id, 'pwb_brand_image', true );
      ...
      $show_desc = get_option('wc_pwb_admin_tab_brand_desc');
        ...
        $brand_banner_url = wp_get_attachment_url( $brand_banner, 'brand-banner' );



        //pwb-brand archive
        if( $brand_banner!='' ){
            echo '<div class="brandBanner" style="background-image:url('.$brand_banner_url.')">';
            echo '<div class="bannerLogo">'.wp_get_attachment_image ( $brand_logo, 'full', false ).'</div>';
