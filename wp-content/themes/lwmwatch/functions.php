...
register_sidebar( array(
		'name'          => __( 'Copyright ', 'twentyseventeen' ),
		'id'            => 'copyright',
		'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
		'before_widget' => '',
		'after_widget'  => '',
	...
	register_sidebar( array(
		'name'          => __( 'Header Search', 'twentyseventeen' ),
		'id'            => 'header-search',
	...
	register_sidebar( array(
		'name'          => __( 'Header User', 'twentyseventeen' ),
		'id'            => 'header-user',
		'description'   => __( '', 'twentyseventeen' ),
		'before_widget' => '',
		'after_widget'  => '',
	...
	register_sidebar( array(
		'name'          => __( 'Top Left ITems', 'twentyseventeen' ),
		'id'            => 'topleftitems',
		'description'   => __( '', 'twentyseventeen' ),
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '<h3 class="title2">',
		'after_title'   => '</h3>',
	) );
	
	
	register_sidebar( array(
		'name'          => __( 'Header Services', 'twentyseventeen' ),
		'id'            => 'header-services',
		'description'   => __( '', 'twentyseventeen' ),
		'before_widget' => ' <div class="services_in">',
		'after_widget'  => '</div>',
		'before_title'  => '',
		'after_title'   => '',
	) );
	...
	register_sidebar( array(
		'name'          => __( 'New Arrivals', 'twentyseventeen' ),
		'id'            => 'new-arrivals',
		'description'   => __( '', 'twentyseventeen' ),
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '<h2 class="products_title">',
		'after_title'   => '</h2>',
	) );
	...
	register_sidebar( array(
		'name'          => __( 'Brands Logo', 'twentyseventeen' ),
		'id'            => 'brands-logo',
		'description'   => __( '', 'twentyseventeen' ),
		'before_widget' => '',
		'after_widget'  => '',
	...
	register_sidebar( array(
		'name'          => __( 'Home Contact Form', 'twentyseventeen' ),
	...
	register_sidebar( array(
		'name'          => __( 'Map Area', 'twentyseventeen' ),
		'id'            => 'map-area',
		'description'   => __( '', 'twentyseventeen' ),
		'before_widget' => '',
		'after_widget'  => '',
	...
	register_sidebar( array(
		'name'          => __( 'CHRONO 24', 'twentyseventeen' ),
		'id'            => 'chrono-24',
		'description'   => __( '', 'twentyseventeen' ),
		'before_widget' => '',
		'after_widget'  => '',
	...
	register_sidebar( array(
		'name'          => __( 'Trusted Seller', 'twentyseventeen' ),
		'id'            => 'trusted-seller',
		'description'   => __( '', 'twentyseventeen' ),
		'before_widget' => '',
		'after_widget'  => '',
...
function twentyseventeen_scripts() {
	...
	wp_enqueue_style( 'brand-style', get_theme_file_uri( '/assets/css/brand.css' ), array( 'twentyseventeen-style' ), '1.0' );
...
function wcs_custom_get_availability( $availability, $_product ) {
    ...
    if ( $_product->is_in_stock() ) {
        $availability['availability'] = __('Buy', 'woocommerce');
    }
    // Change Out of Stock Text
    if ( ! $_product->is_in_stock() ) {
        $availability['availability'] = __('Available On Request', 'woocommerce');
    }
    return $availability;
}


add_image_size( 'brand-banner', 302, 166, true );
...
function add_my_currency_symbol( $currency_symbol, $currency ) {
     switch( $currency ) {
          case 'ABC': $currency_symbol = 'QAR'; break;
     }
...
wp_add_dashboard_widget('custom_help_widget', 'Frontend Management', 'custom_dashboard_help');
}
 
function custom_dashboard_help() {	
	echo '<p><a href="'.get_permalink(936).'products-manage'.'" target="_blank">Go to Frontend</a></p>';
}