...
if( isset( $wp->query_vars['wcfm-products-manage'] ) && !empty( $wp->query_vars['wcfm-products-manage'] ) ) {
	...
	if($product && !empty($product)) {
		...
		$sale_date_from = ( $date = get_post_meta( $product_id, '_sale_price_dates_from', true ) ) ? date_i18n( apply_filters( 'wcfm_date_filter_format', wc_date_format() ), $date ) : '';
		$sale_date_upto = ( $date = get_post_meta( $product_id, '_sale_price_dates_to', true ) ) ? date_i18n( apply_filters( 'wcfm_date_filter_format', wc_date_format() ), $date ) : '';
